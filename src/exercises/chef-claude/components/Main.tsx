          ...
          <section className="suggested-recipe-container">
            ...
            <article aria-live="polite">
              <p>
                ...
                making a delicious <strong>Beef Bolognese Pasta</strong>. Here
                is the recipe:
              </p>
              ...
              <ol>
                ...
                <li>
                  Add the diced onion and minced garlic and cook for 2-3
                  minutes.
                </li>
                ...
                <li>Reduce heat and simmer for 15-20 minutes.</li>
                <li>
                  Cook pasta according to package instructions. Drain and return
                  to pot.
                </li>
                <li>
                  Add the Bolognese sauce to the pasta and toss to combine.
                </li>
                <li>
                  Serve hot, garnished with fresh basil or Parmesan if desired.
                </li>
              </ol>
            </article>
          </section>
